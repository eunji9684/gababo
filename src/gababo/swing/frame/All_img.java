...
public interface All_img {
	...
	ImageIcon panel1_function 				= new ImageIcon("src/img/패널1_function.png");
	ImageIcon panel1_button_회원가입 			= new ImageIcon("src/img/회원가입.png");
	ImageIcon panel1_button_로그인 			= new ImageIcon("src/img/로그인.png");
	ImageIcon panel1_button_승률보기			= new ImageIcon("src/img/승률보기.png");
	ImageIcon panel1_button_플레이순위	 		= new ImageIcon("src/img/플레이순위.png");
	ImageIcon panel1_button_게임종료하기	 	= new ImageIcon("src/img/게임종료하기.png");
